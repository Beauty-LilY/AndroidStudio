package com.example.wanandroidapp2;
...
import com.example.wanandroidapp2.fragment.CategoryFragment;
import com.example.wanandroidapp2.fragment.HomeFragment;
import com.example.wanandroidapp2.fragment.MineFragment;
import com.example.wanandroidapp2.fragment.ProjectFragment;
    ...
    private void selectedFragment(int position){
        ...
        if (position==0){
            if (mHomeFragment==null){
                Toast.makeText(this, "mHomeFragment不存在", Toast.LENGTH_SHORT).show();
                mHomeFragment=new HomeFragment();
                fragmentTransaction.add(R.id.content,mHomeFragment);
            }else {
                Log.d("???","mHomeFragment已存在，直接显示");
